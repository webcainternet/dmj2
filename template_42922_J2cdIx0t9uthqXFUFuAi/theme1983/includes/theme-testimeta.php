...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'theme1983'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Name', 'theme1983'),
    	   'desc' => __('Input author\'s name. ', 'theme1983'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input author\'s URL.', 'theme1983'),
    	   'id' => $prefix . 'testi_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	   ...
    	   'desc' => __('Input author\'s additional info.', 'theme1983'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'theme1983').'</p>';
