...
class MY_CycleWidget extends WP_Widget {
    ...
    function widget($args, $instance) {		
        ...
        ?>
              ...
              <div id="testi-controls">
                <a href="#"><span id="prev-testi"><?php _e('Prev', 'theme1983'); ?></span></a> 
                <a href="#"><span id="next-testi"><?php _e('Next', 'theme1983'); ?></span></a>
                <ul id="nav-testi"></ul>
              </div>
							<!-- end of testimonials -->
							...
							<ul class="news">
								...
								<li>
									...
									<?php if(has_post_thumbnail()) { ?>
										...
										$thumb = get_post_thumbnail_id();
										$img_url = wp_get_attachment_url( $thumb,'full'); //get img URL
										$image = aq_resize( $img_url, 204, 133, true ); //resize & crop img
										?>
										<figure class="featured-thumbnail">
                                    ...
                                    <time datetime="<?php the_time('Y-m-d\TH:i'); ?>"><?php the_time('dS F Y'); ?></time>
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit Text:', 'theme1983'); ?> <input class="widefat" id="<?php echo $this->get_field_id('limit'); ?>" name="<?php echo $this->get_field_name('limit'); ?>" type="text" value="<?php echo $limit; ?>" /></label></p>
      <p><label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Posts per page:', 'theme1983'); ?><input class="widefat" style="width:30px; display:block; text-align:center" id="<?php echo $this->get_field_id('count'); ?>" name="<?php echo $this->get_field_name('count'); ?>" type="text" value="<?php echo $count; ?>" /></label></p>

      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Type of posts:', 'theme1983'); ?><br />
